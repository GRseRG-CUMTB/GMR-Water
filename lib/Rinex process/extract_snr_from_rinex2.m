function [snr_data] = extract_snr_from_rinex2(obsstr, sp3str, elv_lims, ...
    ...
    if size(obsq,1)>0
        ...
        for ii=1:numobs
            ...
            elseif strcmp(obstype(ii,:),'S2') == 1
                s2pos = ii;
            elseif strcmp(obstype(ii,:),'S5') == 1
                s5pos = ii;
            elseif strcmp(obstype(ii,:),'S6') == 1
                s6pos = ii;
            elseif strcmp(obstype(ii,:),'S7') == 1
                s7pos = ii;
            elseif strcmp(obstype(ii,:),'S8') == 1
                s8pos = ii;
            end
        end
    end
